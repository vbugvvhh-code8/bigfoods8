  ...
  return (
    <div className="w-full max-w-[380px] mx-auto px-4 py-14">
      ...
      <p className="text-[12.5px] mt-1 mb-6" style={{color: 'var(--gray)'}}>
        Welcome back — enter your details to keep ordering.
      </p>
      ...
      <form onSubmit={handleLogin}>
        ...
        <div className="mb-5 text-right">
          <Link href="/order/forgot-password" className="text-[11.5px] font-semibold" style={{color: 'var(--orange)'}}>
            Forgot password?
          </Link>
        </div>
      ...
      <p className="text-[12.5px] text-center mt-5" style={{color: 'var(--gray)'}}>
        New to BigFoods?{' '}
        <Link href="/order/signup" className="font-semibold" style={{color: 'var(--orange)'}}>
          Create an account
        </Link>
      </p>
    </div>
