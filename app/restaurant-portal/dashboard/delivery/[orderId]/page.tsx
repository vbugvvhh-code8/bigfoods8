...
import NeedAssistanceModal from '@/components/rider/dashboard/NeedAssistanceModal';
...
export default function DeliveryDetailPage() {
  ...
  return (
    <>
      ...
      <button onClick={() => setShowAssist(true)} className="w-full py-2.5 mt-3 text-[12px]" style={{ color: 'var(--red)', background: 'none', border: 'none' }}>
        Need assistance
      </button>
