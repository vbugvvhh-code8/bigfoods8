...
import { resolveRiderEntryPath } from '@/lib/resolveRiderEntryPath';
...
export default function RiderLoginPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      ...
      const nextPath = await resolveRiderEntryPath(supabase);
    ...
    <div className="max-w-[380px] mx-auto px-4 py-14">
      ...
      <form onSubmit={handleLogin}>
        ...
        <div className="mb-5 text-right">
          <Link href="/rider-portal/forgot-password" className="text-[11.5px] font-semibold" style={{ color: 'var(--orange)' }}>
            Forgot password?
          </Link>
        </div>
      ...
      <p className="text-[12.5px] text-center mt-5" style={{ color: 'var(--gray)' }}>
        New to BigFoods?{' '}
        <Link href="/rider-portal/onboarding/details" className="font-semibold" style={{ color: 'var(--orange)' }}>
          Register as a rider
        </Link>
      </p>
    </div>
