...
import { LayoutGrid, MapPin, Utensils, Bike, Settings, Menu, X, Inbox, AlertTriangle, Wallet, Banknote, Megaphone, Users, LogOut, Route } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { id: '/admin/dispatch', label: 'Dispatch', icon: <Route className="w-4 h-4" /> },
