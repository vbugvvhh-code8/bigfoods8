...
import { PUBLIC_LAUNCH_DATE } from '@/lib/launchDate';
  ...
  return (
    <div className="p-3 rounded-[10px] flex items-center gap-2" style={{ background: 'var(--ink)' }}>
      ...
      <p className="text-[11.5px]" style={{ color: 'white' }}>
        BigFoods launches {PUBLIC_LAUNCH_DATE.toLocaleDateString(undefined, { month: 'long', day: 'numeric', year: 'numeric' })} — make sure your menu and hours are ready.
      </p>
    </div>
  );
}
